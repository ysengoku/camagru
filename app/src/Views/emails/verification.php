    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0"
          ...
          <!-- Header -->
          <tr>
            <td align="center" style="background-color:#002722; padding:28px 40px;">
              <span style="color:#00ebd8; font-size:22px; font-weight:bold; letter-spacing:3px;">CAMAGRU</span>
            </td>
          </tr>
